...
function (_Component) {
  ...
  function SearchBar(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "handleChange", function (event) {
      ...
      }); // this.setState({ result: _.filter(this.props.cursesList, { 'nome': % this.state.searchText% }) })


      _this.setState({
        result: lodash__WEBPACK_IMPORTED_MODULE_11___default.a.some(_this.props.cursesList, lodash__WEBPACK_IMPORTED_MODULE_11___default.a.method('includes', _this.state.searchText))
      });
    });
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(SearchBar, [{
    ...
    value: function render() {
      console.log("aksoadk", this.props.cursesList);
...
//# sourceMappingURL=index.js.ec63e6f0a41191f37972.hot-update.js.map